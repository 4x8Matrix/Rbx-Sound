...
RbxSound.newSoundGroup(GROUP_ASST_NAME, {
	[RbxSound.Effects.PitchShiftSoundEffect] = {
		Octave = 1.25
	}
})

RbxSound.newSound(STINGER_ASSET_NAME, { [RbxSound.Key.Properties] = { SoundId = STINGER_SOUND_ASSET_ID }, [RbxSound.Key.SoundGroup] = GROUP_ASST_NAME }, { })
...
RbxSound.Signal.onBackgroundSoundFinished:Connect(function()
	RbxSound.stopBackgroundSFX(true)
end)